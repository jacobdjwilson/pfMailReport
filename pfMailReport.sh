    ...
    t ) # input tabulated data into HTML table with columns
        ...
        while read line; do
            ...
            for item in $line; do
                if [ $i -lt 2 ]
                then
                echo \<th' 'scope=\"col\"' 'style=\"color\:$table_header_text\;background\-color\:$table_header_background\;text\-align\:left\;\"\>\<p' 'style\=\"margin\:0' '0' '12px' '0\;font\-size\:16px\;line\-height\:24px\;font\-family\:$font\;\"\>$item\<\/p\>\<\/th\>
                else
                    if [ $((i%2)) -eq 0 ]
                    then
                        echo \<td' 'style=\"color\:$default_text\;background\-color\:$even_row_color\;text\-align\:left\;\"\>\<p' 'style\=\"margin\:0' '0' '12px' '0\;font\-size\:16px\;line\-height\:24px\;font\-family\:$font\;\"\>$item\<\/p\>\<\/td\>
                    else
                        echo \<td' 'style=\"color\:$default_text\;background\-color\:$odd_row_color\;text\-align\:left\;\"\>\<p' 'style\=\"margin\:0' '0' '12px' '0\;font\-size\:16px\;line\-height\:24px\;font\-family\:$font\;\"\>$item\<\/p\>\<\/td\>
                    fi
                fi
            done
            if [ $i -lt 2 ]
    ...
    r ) # input tabulated data into HTML table with rows
        ...
        while read -r line; do
            ...
            echo \<tr\>
                if [ $i -lt 2 ]
                then
                echo \<th' 'scope=\"col\"' 'style=\"color\:$table_header_text\;background\-color\:$table_header_background\;text\-align\:left\;padding\:0\;vertical\-align\:top\;\"\>$line\<\/th\>
                else
                    if [ $((i%2)) -eq 0 ]
                    then
                        echo \<td' 'style=\"color\:$default_text\;background\-color\:$even_row_color\;text\-align\:left\;padding\:0\;vertical\-align\:top\;\"\>\<p' 'style\=\"margin\:0' '0' '12px' '0\;font\-size\:16px\;line\-height\:24px\;font\-family\:$font\;\"\>$line\<\/p\>\<\/td\>
                    else
                        echo \<td' 'style=\"color\:$default_text\;background\-color\:$odd_row_color\;text\-align\:left\;padding\:0\;vertical\-align\:top\;\"\>\<p' 'style\=\"margin\:0' '0' '12px' '0\;font\-size\:16px\;line\-height\:24px\;font\-family\:$font\;\"\>$line\<\/p\>\<\/td\>
                    fi
                fi
            if [ $i -lt 2 ]
            then
    ...
    l ) # input tabulated data into HTML ordered list
        ...
        while read -r line; do
            i=$(( i + 1 ))
                if [ $((i%2)) -eq 0 ]
                then
                    echo \<li' 'class=\"list\-group\-item\"' 'style=\"color\:$default_text\;background\-color\:$even_row_color\;text\-align\:left\;\"\>\<p' 'style\=\"margin\:0' '0' '12px' '0\;font\-size\:16px\;line\-height\:24px\;font\-family\:$font\;\"\>$line\<\/p\>\<\/li\>
                else
                    echo \<li' 'class=\"list\-group\-item\"' 'style=\"color\:$default_text\;background\-color\:$odd_row_color\;text\-align\:left\;\"\>\<p' 'style\=\"margin\:0' '0' '12px' '0\;font\-size\:16px\;line\-height\:24px\;font\-family\:$font\;\"\>$line\<\/p\>\<\/li\>
                fi
            echo \<\/ol\>
        done
    ;;
